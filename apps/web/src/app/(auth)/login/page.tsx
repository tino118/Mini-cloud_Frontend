...
function LoginContent() {
  ...
  // redirect can come from register page or navbar "Connexion" button
  const redirect = searchParams.get("redirect") || "/infra";
  ...
  return (
    <div className="min-h-screen bg-[#f4f5f9] flex flex-col items-center justify-start pt-12 px-6 pb-20">
      ...
      <div className="w-full max-w-[480px] bg-white rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.06)] px-10 py-12 flex flex-col items-center">
        ...
        {/* Error */}
        {error && (
          <div className="w-full mb-4 px-4 py-3 bg-red-50 border border-red-100 rounded-xl text-sm text-red-600 font-medium">
            {error}
          </div>
        )}
        ...
        <p className="text-[15px] text-[#0e1133] font-medium mt-7">
          ...
          <Link href="/register" className="text-[#1a73e8] font-bold hover:underline">
            S&apos;inscrire
          </Link>
        </p>
